...
function LogInPage() {
  ...
  const handleSubmit = () => {
    ...
    dispatch(fetchLogin(state)).then((t) => {
      if (t?.payload?.id) {
        if (t?.payload?.role === UserRoles.admin) {
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 col-lg-4">
                <div className="login-wrap p-0">
                  <h3 className="mb-4 text-center">Đăng nhập vào tài khoản của bạn?</h3>
                  <form className="signin-form">
                    ...
                    <div className="form-group">
                      <button
                        ...
                        type="button"
                        className="form-control btn btn-primary submit px-3 login-page"
                      >
                        Đăng nhập
                      </button>
                    </div>
                    <div className="mb-4 text-center">
                      <Link to="/dang-ky" className="redirect">
                        {" "}
                        Đăng ký tài khoản
                      </Link>
                    </div>
